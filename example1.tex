...
Step 2: apply rules to eliminate $\distinct$ operators (the rules can
be found in the full version of the paper), producing a sequence of
equivalent circuits:
...
expansion for the join than the one shown previously, which only
