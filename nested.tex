...
\noindent Step 5: apply the chain rule and use the fact that
$\lift{\delta_0}$ and $\lift{\int}$ are linear:
...
%An example for a transitive closure query is in our report~\cite{tr}.
