...
(This function is also an integrator; its relationship to the $\I$
...
\item Lift this circuit to operate on streams:
    ...
    \end{tikzpicture}
    \end{center}
  Construct $\lift{R}$ by lifting each operator individually, as shown
  by equation (**) in \refsec{sec:streams}.
...
\sv{$x$ $x$ $x$ $x$ $x$}.  The feedback cycle in this circuit as a
