...
name because it is strongly related to the SQL \texttt{DISTINCT}
operator).  This function, applied to a \zr, gives us another \zr
...
is changing sign (positive to negative or vice-versa) when the row
appears in a new change.  A precise definition of $H$ is given in the
