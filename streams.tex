...
etc.  The delay operator is similar to a \emph{latch}~\cite{latch} in
...
we emphasize how it applies in the domain of databases.  We directly
tie these results to databases in the next section.
