...
\textbf{Primary keys} in a table change its behavior on insertion:
...
\textbf{Streaming Window queries}
...
\textbf{Slow Tests Due to Column Families} Our core engine is tested
